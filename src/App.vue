...
<template>
    <section class="container mx-auto p-10">
        ...
        <!-- <section class="main flex space-x-4 py-5">
            <div class="flex space-y-4 flex-col w-1/2">
                <img v-bind="picture">
                <h2 class="text-xl text-left"> {{ picture.title }}</h2>
                <a target="_blank" :href="picture.link" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded w-40 text-center">
                    Image Source
                </a>
            </div>
        </section> -->
